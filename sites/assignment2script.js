...
(function (global) {
    ...
    var menuItemsTitleHtml = "./snippets/menu-items-titles.html";
    ...
    function buildAndShowCategoriesHTML (categories){
        $ajaxUtils2.sendGetRequest(
            categoriesTitleHtml, function(categoriesTitleHtml) {
                $ajaxUtils2.sendGetRequest(categoryHtml, function(categoryHtml){
    ...
    function buildAndShowMenuItemsHTML (categoryMenuItems) {
        $ajaxUtils2.sendGetRequest(menuItemsTitleHtml, 
    ...
    for (var i = 0; i < menuItems.length; i++) {
        ...
        html = insertItemPortionName(html, "price_small", menuItems[i].small_portion_name);
